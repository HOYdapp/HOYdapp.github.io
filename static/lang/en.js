module.exports = {
    message: {
        ...
        f_23:'Advantage of project',
        f_24:'HOY is a comprehensive one-stop service platform in the field of NFT. Users can freely collect and trade NFT on the platform, and can also help high-quality projects, collection artists and other NFT assets for the first sale.',
        f_29_2:'Partners',
        ...
        f_47:'Confirm',
        f_48:'Note: The smart contract will automatically calculate the number of currencies to be destroyed when the user enters the number of mining calculation force (1 H/s=1 USDT). At least 100 H/s to participate, all participating currencies will enter the black hole address for destruction. The smart contract will reward four times of mining calculation force according to the U price of the destruction currency.',
